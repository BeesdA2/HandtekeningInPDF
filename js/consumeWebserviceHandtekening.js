...
async function handtekeningPlaatsenProefrit (origineelDocument, handTekening, xxText, yyText) {
  try{
...
async function handleHandtekeningPlaatsen (origineelDocument, handTekening, xxText, yyText, proefrit)
{
	if ((proefrit).trim() === 'N')
	 {	
	...
	var resolve = await handtekeningPlaatsenProefrit (origineelDocument,handTekening, xxText, yyText );
	return (resolve);
    }
	catch(err) {}
    }
